...
public class OrderServiceImpl implements OrderService {
	...
	public boolean saveCartOrder(int orderNum, String customerName, String customerEmail, String customerPhone,
			String customerAddress,String customerDeliveryTime, String customerAddressType, double amount, boolean active, Date orderDate) {
		boolean status = false;
		if (orderNum != 0) {
			status = true;
			orderRepository.saveOrders(orderNum, customerName, customerEmail, customerPhone, customerAddress, customerDeliveryTime, customerAddressType, amount, active, orderDate);		}
		return status;
	}
