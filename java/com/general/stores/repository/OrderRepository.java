...
public interface OrderRepository extends JpaRepository<Order, Long> {
	...
	@Modifying
	@Query(value = "insert into orders (order_num, customer_name, customer_email, customer_phone, customer_address, customer_delivery_time, customer_address_type, amount, active, order_date) VALUES (:orderNum, :customerName, :customerEmail, :customerPhone, :customerAddress,:customerDeliveryTime, :customerAddressType, :amount, :active, :orderDate)", nativeQuery = true)
	void saveOrders(@Param("orderNum") int orderNum, @Param("customerName") String customerName,@Param("customerEmail") String customerEmail,@Param("customerPhone") String customerPhone,@Param("customerAddress") String customerAddress,@Param("customerDeliveryTime") String customerDeliveryTime,@Param("customerAddressType") String customerAddressType, @Param("amount") double amount,
