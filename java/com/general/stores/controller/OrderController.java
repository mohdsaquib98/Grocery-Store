...
public class OrderController {
	...
	String checkOutOrder(@RequestParam("customerName") String customerName,
			...
			@RequestParam("deliveryTime")String customerDeliveryTime,
			@RequestParam("addressType") String customerAddressType,
			@RequestParam("pinCode") String pinCode, HttpServletRequest request, HttpSession session,
		...
		try {
			...
			order.setCustomerDeliveryTime(customerDeliveryTime);
