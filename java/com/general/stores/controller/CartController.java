...
public class CartController {
	...
	String cartItemsCheckout(@RequestParam("customerName") String customerName,
			@RequestParam("customerPhone") String customerPhone, @RequestParam("address") String customerAddress,@RequestParam("deliveryTime") String customerDeliveryTime,
		...
		try {
			...
			if (customerEmail != null) {
				...
				for (int i = 1; i <= count; i++) {
					...
					order = new Order(orderNum, totalAmount, customerName, customerAddress,customerDeliveryTime, customerAddressType, customerEmail, customerPhone, pinCode, active, orderDate);
